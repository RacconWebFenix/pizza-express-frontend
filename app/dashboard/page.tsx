...
export default function DashboardPage() {
  ...
  // Estados para controlar exibição do formulário
  ...
  const handlePizzaCreated = (pizza: Pizza) => {
    ...
    // Aqui você pode atualizar a lista de pizzas, mostrar notificação, etc.
  };
          ...
          <Box textAlign="center" mb={6}>
            <Heading color="brand.primary" size="2xl" mb={4}>
              <Flex align="center" justify="center" gap={3}>
                <Icon as={FaPlus} color="brand.accent" />
                Criar Nova Pizza
              </Flex>
            </Heading>
            <Text color="brand.medium" fontSize="lg">
              Adicione uma nova pizza ao cardápio com imagem
            </Text>
          </Box>
        ...
        <>
              ...
              >
                <VStack align="stretch" gap={5}>
                  ...
                  <Text color="brand.medium" fontSize="lg" lineHeight="tall">
                    Gerencie o cardápio, adicione novas pizzas e edite
                    informações.
                  </Text>
          ...
          >
            ...
            <Text
              ...
              lineHeight="tall"
            >
              💡 <strong>Dica Profissional:</strong> Use o painel de
              estatísticas para monitorar o desempenho da pizzaria em tempo
              real. Para acessar funcionalidades avançadas, navegue pelas seções
              específicas.
            </Text>
          </Box>
        </>
